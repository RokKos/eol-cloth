...
namespace EOL {
	...
	void Obstacles::draw(std::shared_ptr<Rendering::MatrixStack> MV, const std::shared_ptr<Rendering::Program> p) const
	{
	...
	void Obstacles::drawSimple(std::shared_ptr<Rendering::MatrixStack> MV, const std::shared_ptr<Rendering::Program> p) const
	{
		//for (int i = 0; i < boxes.size(); i++) {
