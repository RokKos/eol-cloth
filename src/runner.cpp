...
namespace EOL {
	...
	shared_ptr<Rendering::Camera> camera;
	shared_ptr<Rendering::Program> progPhong;
	shared_ptr<Rendering::Program> progSimple;
#endif // EOLC_ONLINE
	...
	bool init_online(const string& SIMSET_FILE)
	{
		...
		progSimple = make_shared<Rendering::Program>();
		...
		progPhong = make_shared<Rendering::Program>();
		...
		camera = make_shared<Rendering::Camera>();
		...
		Rendering::GLSL::checkError(GET_FILE_LINE);
	...
	void render()
	{
		...
		auto P = make_shared<Rendering::MatrixStack>();
		auto MV = make_shared<Rendering::MatrixStack>();
